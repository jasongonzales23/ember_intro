...
Ember.TEMPLATES["delete-button"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
function program4(depth0,data) {
  ...
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "createNewCategory", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  data.buffer.push(">&plus;</button>\n    </span>\n  </div><!-- /input-group -->\n</div>\n\n<ul class=\"list-group\">\n  <li class=\"list-group-item\">\n  ");
